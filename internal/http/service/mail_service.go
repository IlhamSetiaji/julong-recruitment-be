...
func NewMailService(log *logrus.Logger, viper *viper.Viper) IMailService {
	return &MailService{
		Log:   log,
		Viper: viper,
	}
...
func MailServiceFactory(log *logrus.Logger, viper *viper.Viper) IMailService {
	return NewMailService(log, viper)
}
