...
type FgdScheduleResponse struct {
	...
	Status                     entity.FgdScheduleStatus `json:"status"`
	...
	FgdApplicants            []FgdApplicantResponse            `json:"fgd_applicants"`
	FgdAssessors             []FgdAssessorResponse             `json:"fgd_assessors"`
}

type FgdScheduleMyselfResponse struct {
	ID                         uuid.UUID                `json:"id"`
	JobPostingID               uuid.UUID                `json:"job_posting_id"`
	ProjectPicID               uuid.UUID                `json:"project_pic_id"`
	ProjectRecruitmentHeaderID uuid.UUID                `json:"project_recruitment_header_id"`
...
type FgdScheduleMyselfForAssessorResponse struct {
	ID                         uuid.UUID                `json:"id"`
	JobPostingID               uuid.UUID                `json:"job_posting_id"`
	ProjectPicID               uuid.UUID                `json:"project_pic_id"`
	ProjectRecruitmentHeaderID uuid.UUID                `json:"project_recruitment_header_id"`
