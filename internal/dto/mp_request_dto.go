...
func MPRequestDTOFactory(
	log *logrus.Logger,
) IMPRequestDTO {
	return NewMPRequestDTO(log)
}

func (d *MPRequestDTO) ConvertMapInterfaceToResponse(mprMap map[string]interface{}) (*response.MPRequestHeaderResponse, error) {
